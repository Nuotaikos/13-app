...
async function start() {
  try {
    await mongoose.connect(
      'mongodb+srv://Nuotaikos:Java2033@cluster0.ls1rips.mongodb.net/todos',
      {
...
// app.use(express.urlencoded({ extended: true }))
// app.use(express.static(path.join(__dirname, 'public'))) //kelias iki publick segtuvo. Express dabar zinos, kad duotas segtuvas path.join yra nuroodytame kelyje ir yra ststic
